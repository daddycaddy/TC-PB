...
void PlayerbotFactory::InitSpecialSpells()
{
	...
	case CLASS_WARRIOR:
		...
		if (bot->getLevel() > 9)
		{
			bot->LearnSpell(71, 7386, false); //Defensive stance and sunder armor
		}
		else if (bot->getLevel() > 29)
		{
			bot->LearnSpell(2458, 20252, false); //Berserker stance and Intercept
		
		} 
		//tab=0=arms					//level		
		else if ((tab == 0) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(9347, 1680, false); //Mortal Strike, Whirlwind
		}
		//tab=1=fury			//level

		else if ((tab == 1) && bot->getLevel() > 39)
		{
			bot->LearnSpell(13078, 1680, false); //Bloodthirst, Whirlwind
		}
		//tab=2=prot			//level
		...
		{
			bot->LearnSpell(25710, false); //Heroic Strike
		}
		break;
	...
	case CLASS_DRUID:
		...
		(bot->getLevel() > 9)
		{
			bot->LearnSpell(5487, 6795, 6807); //Bear form, Growl and Maul
		}
		...
		{
			bot->LearnSpell(768, false); //Cat form
		}
		else if (bot->getLevel() > 29)
		{
			bot->LearnSpell(783, false); //Travel Form
		}
		else if (bot->getLevel() > 39)
		{
			bot->LearnSpell(24858, 9634, false); //Moonkin form and Dire Bear form
		}
		//tab=1=feral			//level 
		...
		{
			bot->LearnSpell(17007, 9634, false); //Leader of the Pack and Dire Bear Form
		}
		//tab=2=resto			//level 

		else if ((tab == 2) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(783, 17116, false); //Travel Form and Nature's Swiftness
		}
		else if ((tab == 2) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(9634, 18562, false); //Dire Bear Form and Swiftmend
		}
		else
		{
			bot->LearnSpell(5176, false); //Wrath
		}
	...
	case CLASS_MAGE:
		...
		{
			bot->LearnSpell(12043, false); //Presence of Mind
		}
		else if ((tab == 0) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(12042, false); //Arcane Power
		}
		
		else if //tab=1=fire			//level				
			((tab == 1) && (bot->getLevel() > 19))
		{
			bot->LearnSpell(11366, false); //Pyroblast
		}
		else if ((tab == 1) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(11113, false); //Blast Wave
		}
		else if ((tab == 1) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(11129, false); //Combustion
		}
		else if //tab=2=frost			//level 				
			((tab == 2) && (bot->getLevel() > 19))
		{
			bot->LearnSpell(12472, false); //Cold Snap
		}
		else if ((tab == 2) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(11958, false); //Ice Block
		}
		else if ((tab == 2) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(11426, false); //Ice Barrier
		}
		else
		{
	...
	case CLASS_HUNTER:
		...
		if
			(bot->getLevel() > 8)
		{
			bot->LearnSpell(1515, 883, 2641); //Tame Beast, Call pet, Dismiss pet, Beast Training, Feed Pet, Revive Pet
		}
		else if
			(bot->getLevel() > 9)
		{
			bot->LearnSpell(5149, 6991, 982); //Tame Beast, Call pet, Dismiss pet, Beast Training, Feed Pet, Revive Pet
		}
		//tab=0=beastmastery					//level	

		else if ((tab == 0) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(19577, false); //Intimidation
		}
		else if ((tab == 0) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(19574, false); //Bestial Wrath
		}
		...
		{
			bot->LearnSpell(19434, false); //Aimed Shot
		}
		else if ((tab == 1) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(19503, false); //Scatter Shot
		}
		else if ((tab == 1) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(19506, false); //Trueshot Aura
		}
		//tab=2=survival			//level 	

		else if ((tab == 2) && (bot->getLevel() > 19))
		{
			bot->LearnSpell(19263, false); //Deterrence
		}
		else if ((tab == 2) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(19306, false); //Counterattack
		}
		else if ((tab == 2) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(19386, false); //Wyverne Sting
		}
		else
		{
	...
	case CLASS_PALADIN:
		...
		{
			bot->LearnSpell(26573, false); //Consecration
		}
		else if ((tab == 0) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(20216, false); //Divine Favor
		}
		else if ((tab == 0) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(20473, false); //Holy Shock
		}
		...
		{
			bot->LearnSpell(20217, false); //Blessing of Kings
		}
		else if ((tab == 1) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(20911, false); //Blessing of Sanctuary
		}
		else if ((tab == 1) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(20925, false); //Holy Shield
		}
		//tab=2=retri			//level 	

		else if ((tab == 2) && (bot->getLevel() > 19))
		{
			bot->LearnSpell(20375, false); //Seal of Command
		}
		else if ((tab == 2) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(20218, false); //Sanctity Aura
		}
		else if ((tab == 2) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(20066, false); //Repentance
		}
		else
		{
			bot->LearnSpell(20154, false); //Seal of Righteousness
		}
		break;
	...
	case CLASS_PRIEST:
		...
		{
			bot->LearnSpell(14751, false); //Inner Focus
		}
		else if ((tab == 0) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(14752, false); //Divine Spirit
		}
		else if ((tab == 0) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(10060, false); //Power Infusion
		}

		else if //tab=1=holy			//level					
			((tab == 1) && (bot->getLevel() > 19))
		{
			bot->LearnSpell(15237, false); //Holy Nova
		}
		else if ((tab == 1) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(20711, false); //Spirit of Redemption
		}
		else if ((tab == 1) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(724, false); //Lightwell
		}
		else if //tab=2=shadow			//level 					
			((tab == 2) && (bot->getLevel() > 19))
		{
			bot->LearnSpell(15407, false); //Mind Flay
		}
		else if ((tab == 2) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(15487, 15286, false); //Silence and Vampiric Embrace
		}
		else if ((tab == 2) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(15473, false); //Shadowform
		}
		else
		{
			bot->LearnSpell(585, false); //Smite
		}
		break;
	...
	case CLASS_ROGUE:
		...
		if
			(bot->getLevel() > 19)
		{
			bot->LearnSpell(2842, 1752, false); //Poisons,Sinister Strike
		}
		//tab=0=assa					//level		
		else if ((tab == 0) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(14177, false); //Cold Blood
		}
		else if ((tab == 0) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(14983, false); //Vigor
		}
		//tab=1=combat			//level		

		else if ((tab == 1) && (bot->getLevel() > 19))
		{
			bot->LearnSpell(14251, false); //Riposte
		}
		else if ((tab == 1) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(13877, false); //Blade Flurry
		}
		else if ((tab == 1) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(13750, false); //Adrenaline Rush
		}
		//tab=2=sub			//level 			

		else if ((tab == 2) && (bot->getLevel() > 19))
		{
			bot->LearnSpell(14278, false); //Ghostly Strike
		}
		else if ((tab == 2) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(16511, 14185, false); //Hemorrhage and Preparation
		}
		else if ((tab == 2) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(14183, false); //Premeditation
		}
	...
	case CLASS_SHAMAN:
		...
		if
			(bot->getLevel() > 19)
		{
			bot->LearnSpell(2645, false); //Ghost Wolf
		}
		//tab=0=ele					//level		
		else if ((tab == 0) && (bot->getLevel() > 19))
		{
			bot->LearnSpell(16164, false); //Elemental Focus
		}
		else if ((tab == 0) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(16166, false); //Elemental Mastery
		}
		...
		{
			bot->LearnSpell(16269, false); //Two-Handed axes and maces
		}
		else if ((tab == 1) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(16268, false); //Parry
		}
		else if ((tab == 1) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(17364, false); //Stormstrike
		}
		...
		{
			bot->LearnSpell(16188, false); //Nature's Swiftness
		}
		else if ((tab == 2) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(16190, false); //Mana Tide Totem
		}
		else
		{
			bot->LearnSpell(403, false); //Lightning Bolt
		}
		break;
	...
	case CLASS_WARLOCK:
		...
		{
			bot->LearnSpell(18288, false); //Amplify Curse
		}
		else if ((tab == 0) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(18223, 18265, false); //Curse of Exhaustion and Siphon Life
		}
		else if ((tab == 0) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(18220, false); //Dark Pact
		}
		...
		{
			bot->LearnSpell(18708, false); //Fel Domination
		}
		else if ((tab == 1) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(18788, false); //Demonic Sacrifice
		}
		else if ((tab == 1) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(19028, false); //Soul Link
		}
		//tab=2=destro			//level 			
		...
		{
			bot->LearnSpell(17877, false); // Shadowburn
		}
		else if ((tab == 2) && (bot->getLevel() > 29))
		{
			bot->LearnSpell(17959, false); // Ruin Talent	
		}
		else if ((tab == 2) && (bot->getLevel() > 39))
		{
			bot->LearnSpell(17962, false); // Conflagrate					
		}
		else
		{
			bot->LearnSpell(686, false); //Shadow Bolt
		}
		break;
	}
